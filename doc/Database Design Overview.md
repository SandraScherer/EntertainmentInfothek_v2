...
| AspectRatio  | BusinessModel | CDROMDriveSpeed | CPU          | Camera       | CinematographicProcess | Color       | CopyProtection | Country           | Department  | Difficulty  | DirectX      | Driver      | Edition     | FilmFormat   | Genre       | Hardware    | InputDevice | InputDeviceFeature | Language     | MacOSSprocket | MediaType    | MultiplayerGameMode | MultiplayerOption | OperatingSystem | Perspective | Platform     | Position    | Priority    | Profession  | RAM          | SaveGameMethod | Setting     | SoundDevice | SoundMix     | SoundMode    | Species     | Status      | System      | Type        | VideoMode   | VideoResolution |     |
| ------------ | ------------- | --------------- | ------------ | ------------ | ---------------------- | ----------- | -------------- | ----------------- | ----------- | ----------- | ------------ | ----------- | ----------- | ------------ | ----------- | ----------- | ----------- | ------------------ | ------------ | ------------- | ------------ | ------------------- | ----------------- | --------------- | ----------- | ------------ | ----------- | ----------- | ----------- | ------------ | -------------- | ----------- | ----------- | ------------ | ------------ | ----------- | ----------- | ----------- | ----------- | ----------- | --------------- | --- |
